...
# Optunaでチューニング
# VGGでKNN（全画像利用）：除外
# New: tsneからBertを抜いて非圧縮で独立させる
# MAP@12 (all): 0.032745
# MAP@12 (cold start): 0.007654
EXP = '045'
...
def _generate_candidates_desc_knn(transactions: pd.DataFrame, customers: np.ndarray, target_week: int, encoder: str):
    ...
    desc_knn = pd.read_csv(f'../input/ranking_features/item_features_{encoder}_class_tfidf.csv', dtype={'article_id': 'int32'})
