...
# Bert非圧縮除外、tsneはtf-idfとbert、多分ベストサブ
# New: 大きいモデルにあうパラメータを探す
# EXP053と同じ
# MAP@12 (all): 0.032000
# MAP@12 (cold start): 0.008205
# num_leaves 31 -> 80
# MAP@12 (all): 0.031372
# MAP@12 (cold start): 0.007578
# num_leaves 31 -> 20
# MAP@12 (all): 0.031755
# MAP@12 (cold start): 0.007866
# num_leaves 31 -> 60
# MAP@12 (all): 0.031462
# MAP@12 (cold start): 0.007939
...
params = {
    ...
    'num_iterations': 1000,
    'learning_rate': 0.1,
    'num_leaves': 60,  # default: 31, large for accuracy
    'num_threads': cpu_count(logical=False),
    'random_state': 71,  # 訓練用とは違うシードにする
...
# predict val data
val_df = make_data_df(transactions, 1, is_labeled=False, metric_verbose=True, compress_verbose=False)
