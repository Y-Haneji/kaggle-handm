...
# KNN自分自身を抜かない
# New: BertのPretrain変える: bert-base-cased-finetuned-mrpc (n_neighbors=5)
# lightgbm.basic.LightGBMError: Number of rows 11180 exceeds upper limit of 10000 for a query
...
def _generate_candidates_bert_knn(transactions: pd.DataFrame, customers: np.ndarray, target_week: int):
    ...
    pretrain_name = '_' + 'bert-base-cased-finetuned-mrpc'
    bert_knn = pd.read_csv(f'../input/ranking_features/article_bert_pairs{pretrain_name}.csv', dtype={'article_id': 'int32'}, usecols=usecols)
