...
# KNNで自分自身を抜く
# New: 良い手法を広げる（bin popular, tsne, 圧縮word2vec）
# MAP@12 (all): 0.033042
# MAP@12 (cold start): 0.006824
...
def _generate_candidates_desc_knn(transactions: pd.DataFrame, customers: np.ndarray, target_week: int, encoder: str):
    ...
    n_neighbors = 20
    desc_knn = pd.read_csv(f'../input/ranking_features/item_features_{encoder}_class_tfidf_{n_neighbors}items.csv', dtype={'article_id': 'int32'})
